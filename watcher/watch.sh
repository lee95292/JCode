#! /bin/bash
#usage: nohup ./watch.sh &
HOME="/home/ubuntu"
TARGET="/var/log/Watcher/$(hostname)"
#TARGET="/home/ubuntu/$(hostname)"


echo "*** Watcher service is started! $(date)"
...
while [ 1 ]; do 
	...
	if [ ! -z $ACTDIR ]; then
		...
		echo "*** Update file: $HOME/${ACTDIR}/${FILENAME} at $(date)"
                ...
                /usr/lib/Watcher/client ${TARGET}/${ACTDIR}/${FILENAME}/${origindate} 10.0.0.254
